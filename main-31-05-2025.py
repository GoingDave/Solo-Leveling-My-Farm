...
def Garage():
    ...
    if Traktor_Dictionary["Traktor"].Anzahl == 0:
        ...
        print(f"\n\nDu hast {Münzen} Münzen")
        Traktor_Kauf = input(f"\n1. Traktor ({Traktor_Dictionary["Traktor"].Preis} Münzen.\n\n\nHauptmenü -> 'Entertaste'.\n\n")
...
def Random_event():
    ...
    if Event.name == "Nothing":
        ...
        Gewinn = ((Wochenzähler+ 150)*Runden) * 50
        print("Du hast im Lotto gewonnen! 🎉" )
        print(f"Du hast {Gewinn} Münzen erhalten")
...
Maschinen_Dictionary = {
    "Mühle": Maschinen("Mühle", 5000, "❌", 40),
    "Zerkleinerungsmixer": Maschinen("Zerkleinerungsmixer", 5000, "❌", 40),
    "Schneidemaschine": Maschinen("Schneidemaschine", 5000, "❌", 40),
    "Mixer": Maschinen("Mixer", 5000, "❌", 40),
    "Schleudermaschine": Maschinen("Schleudermaschine", 5000, "❌", 40),
    "Käsemaschine": Maschinen("Käsemaschine", 5000, "❌", 40),
    "Knetmaschine": Maschinen("Knetmaschine", 5000, "❌", 40),
    "Backofen": Maschinen("Backofen", 5000, "❌", 40),
    "Herd": Maschinen("Herd", 5000, "❌", 40),
    "Fritteuse": Maschinen("Fritteuse", 5000, "❌", 40),
    "Webstuhl": Maschinen("Webstuhl", 5000, "❌", 40),
    "Verpackungsmaschine": Maschinen("Verpackungsmaschine", 5000, "❌", 40),
}
...
Anlagen_Dic = {
    "Streichelzoo" : Anlagen("Streichelzoo",15000,0,Upgrade_Dic0[0]),
    "Restaurant" : Anlagen("Restaurant",20000,0,Upgrade_Dic1[0]),
    "Souvenir_Laden" : Anlagen("Souvenir_Laden",10000,0,Upgrade_Dic2[0])
}
    ...
    if Lager_Dictionary["Tierfutter"].Anzahl <= 0 and Tierfutter_Dictionary["Tierfutter"].Verbrauch > 0:
        ...
        while Futterverbrauch > Futterproduktion:
            ...
            if tiere_mit_anzahl:
                ...
                Tierfutter_Dictionary["Tierfutter"].Verbrauch -= tier.Tierfutter
